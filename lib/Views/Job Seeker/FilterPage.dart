        ...
        child: Row(
          ...
          children: [
            ...
            Container(
             ...
             currentIndex == 1 ?
             Container(
               child: addJobDataModel == null ? Center(child: Text("No data to show"),) : addJobDataModel!.data!.jobTypes!.length == 0 ? Center(child: Text("No Job Type is available"),) : 
               ListView.builder(
                   shrinkWrap: true,
            ...
            Container(
             ...
             Container(
               child: addJobDataModel == null ? Center(child: Text("No data to show"),) : addJobDataModel!.data!.experiences!.length == 0 ? Center(child: Text("No experience is available"),) :
               ListView.builder(
                   shrinkWrap: true,
