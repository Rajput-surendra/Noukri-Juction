...
class _SeekerProfileDetailScreenState extends State<SeekerProfileDetailScreen> {
  ...
  intialFunction()async{
    ...
    setState(() {
      ...
      specialization = seekerProfileModel!.data!.specialization == "0" || seekerProfileModel!.data!.specialization == "null" || seekerProfileModel!.data!.specialization == null  ? null : seekerProfileModel!.data!.specialization.toString();
      selectedExperience = seekerProfileModel!.data!.exp == "0" || seekerProfileModel!.data!.exp == "null" ? null : seekerProfileModel!.data!.exp.toString();
      selectedRole = seekerProfileModel!.data!.jobRole == "0" || seekerProfileModel!.data!.jobRole == null || seekerProfileModel!.data!.jobRole == "null" ? null : seekerProfileModel!.data!.jobRole.toString() ;
      selectedDesignation = seekerProfileModel!.data!.designation == "0" || seekerProfileModel!.data!.designation == null || seekerProfileModel!.data!.designation == "null" ? null :seekerProfileModel!.data!.designation.toString() ;
      selectedJobType = seekerProfileModel!.data!.jobType == "0" || seekerProfileModel!.data!.jobType == null || seekerProfileModel!.data!.jobType == "null" ? null : seekerProfileModel!.data!.jobType.toString() ;
      selectedQualification = seekerProfileModel!.data!.qua == "0" || seekerProfileModel!.data!.qua == null || seekerProfileModel!.data!.qua == "null" ? null : seekerProfileModel!.data!.qua.toString();
      gender = seekerProfileModel!.data!.gender == "0" || seekerProfileModel!.data!.gender == null  ?  "" : seekerProfileModel!.data!.gender.toString();
      // filesPath = seekerProfileModel!.data!.resume == "0" || seekerProfileModel!.data!.resume == null  ? "" : seekerProfileModel!.data!.resume;
      resumeData =  seekerProfileModel!.data!.resume == "0" || seekerProfileModel!.data!.resume == "null"  ? null : seekerProfileModel!.data!.resume.toString();
      status = seekerProfileModel!.data!.status == "0" || seekerProfileModel!.data!.status == null  ? "" : seekerProfileModel!.data!.status;
      profileImage = seekerProfileModel!.data!.img == "0" || seekerProfileModel!.data!.img == null ? "" : seekerProfileModel!.data!.img;
    });
            ...
            child: seekerProfileModel == null  || addJobDataModel == null  ? Center(child: CircularProgressIndicator(),) : Column(
              ...
              children: [
                    ...
                    child: DropdownButtonHideUnderline(
                      child: DropdownButton(
                        ...
                        hint: Padding(
                          ...
                          child: Text("${getTranslated(context, 'preferredLocation')}"),
                        ),
                        // Down Arrow Icon
                        icon: const Icon(Icons.keyboard_arrow_down),
                        // Array list of items
                  ...
                  child: Container(
                    ...
                    child: DropdownButtonHideUnderline(
                      child: DropdownButton(
                        ...
                        hint: Padding(
                          padding: const EdgeInsets.only(left: 10),
                          child: Text("${getTranslated(context, 'selectQualification')}"),
                        ),
                        icon: const Icon(Icons.keyboard_arrow_down),
                        // Array list of items
                  ...
                  child: Container(
                    ...
                    child: DropdownButtonHideUnderline(
                      child: DropdownButton(
                        ...
                        hint: Padding(
                          padding: const EdgeInsets.only(left: 10),
                          child: Text("${getTranslated(context, 'selectJobRole')}"),
                        ),
                        // Array list of items
                  ...
                  child: Container(
                    ...
                    child: DropdownButtonHideUnderline(
                      child: DropdownButton(
                        ...
                        hint: Padding(
                          padding: const EdgeInsets.only(left: 10),
                          child: Text("${getTranslated(context, 'selectDesignation')}"),
                        ),
                        // Down Arrow Icon
                        icon: const Icon(Icons.keyboard_arrow_down),
                        // Array list of items
                  ...
                  child: Container(
                    ...
                    child: DropdownButtonHideUnderline(
                      child: DropdownButton(
                        ...
                        hint: Padding(
                          padding: const EdgeInsets.only(left: 10),
                          child: Text("${getTranslated(context, 'selectJobType')}"),
                        ),
                        // Array list of items
                  ...
                  child: DropdownButtonHideUnderline(
                    child: Container(
                      ...
                      child: DropdownButton(
                        ...
                        hint: Padding(
                          padding: const EdgeInsets.only(left: 10),
                          child: Text("${getTranslated(context, 'currentCtc')}"),
                        ),
                        icon: const Icon(Icons.keyboard_arrow_down),
                        // Array list of items
                  ...
                  child: Container(
                    ...
                    child: DropdownButtonHideUnderline(
                      child: DropdownButton(
                        ...
                        hint: Padding(
                          padding: const EdgeInsets.only(left: 10),
                          child: Text("${getTranslated(context, 'expectedCtc')}"),
                        ),
                        icon: const Icon(Icons.keyboard_arrow_down),
                        // Array list of items
                    ...
                    child: DropdownButtonHideUnderline(
                      child: DropdownButton(
                        ...
                        hint: Padding(
                          ...
                          child: Padding(
                            padding: const EdgeInsets.only(left: 10),
                            child: Text("${getTranslated(context, 'selectExperience')}"),
                          ),
                        ),
                        icon: const Icon(Icons.keyboard_arrow_down),
                        // Array list of items
                  ...
                  child: Container(
                    ...
                    child: DropdownButtonHideUnderline(
                      child: DropdownButton(
                        ...
                        hint: Padding(
                          padding: const EdgeInsets.only(left: 10),
                          child: Text("${getTranslated(context, 'Specilization')}"),
                        ),
                        icon: const Icon(Icons.keyboard_arrow_down),
                        // Array list of items
                  ...
                  child: Container(
                    ...
                    child: DropdownButtonHideUnderline(
                      child: DropdownButton(
                        ...
                        hint: Padding(
                          padding: const EdgeInsets.only(left: 10),
                          child: Text("${getTranslated(context, 'noticePeriods')}"),
                        ),
                        icon: const Icon(Icons.keyboard_arrow_down),
                        // Array list of items
                ...
                Padding(
                  ...
                  child: const Text("Upload Resume (DOCX/PDF)", style: TextStyle(fontSize: 16,fontWeight: FontWeight.bold,),),
                ),
                InkWell(
                  onTap: (){
                    _pickFile();
